                  ...
                  child: Column(
                    children: [
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              ...
                              child:
                                  cubit.state.user.avt.isNotEmpty
                                      ? CircleAvatar(
                                        radius: 50,
                                        backgroundImage:
                                            Image.asset(
                                              cubit.state.user.avt,
                                            ).image,
                                      )
                                      : Container(
                      ...
                      Row(
                        ...
                        children: [
                          Text('Thành tựu', style: AppTextStyles.headline),
                          TextButton(
                            onPressed: () {
                              Navigator.of(
                                context,
                              ).pushNamed(AchievementScreen.route, arguments: {
                                'cubit' : cubit
                              });
                            },
                            child: Text(
                      ...
                      SizedBox(height: 8),
                      calendar(MediaQuery.sizeOf(context).width, cubit.state.streak),
                    ],
                  ),
                ),
              );
